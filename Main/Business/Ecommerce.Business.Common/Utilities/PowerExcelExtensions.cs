...
namespace Ecommerce.Business.Common.Utilities
{
    static class PowerExcelExtensions
    {
        ...
        internal static object GetPropertyValue(ColumnInfo columnInfo, object o, object val, ICell cell)
        {
            ...
            else if (columnInfo.IsNullable && (val == null || val is string s && s.Length == 0) && columnInfo.PropertyType == typeof(string)) //CHANGES FOR EcommerceNODE
                v = ""; 
